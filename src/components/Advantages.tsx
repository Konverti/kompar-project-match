      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
          {advantages.map((advantage, index) => (
            <div 
              key={index}
              className="bg-card p-4 md:p-8 rounded-2xl shadow-soft hover:shadow-strong transition-all duration-300 animate-fade-in flex flex-col md:flex-row gap-4 md:gap-6"
